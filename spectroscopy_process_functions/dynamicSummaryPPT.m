...
replace(presentationTitleSlide, 'Title 1', ['Subject ', subject_id, '_', num2str(rf_excitation), 'ppm', 10, 'Spectroscopy Summary']);
...
% Prepare oscillation peaks fitting values
amp = amp_all.peaks;
...
% Add Static table
static_params = {''; ['Intensity', 10, 'Ratio*']; ['Shift (inc.)', 10, '(ppm)']; ...
    ['Shift (ded.)', 10, '(ppm)']; ['FWHM', 10, '(ppm)']; ['FWHMg', 10, '(ppm)']; ...
...
if sum(nmrFit_ppm.fwhmG(:)) > 0
    ...
    rbc_static = {''; sprintf('%3.3f', nmrFit_ppm.area(1)); ...
        sprintf('%4.1f', nmrFit_ppm.freq_inc(1)); ...
        sprintf('%4.1f', nmrFit_ppm.freq_ded(1)); ...
    ...
    rbc_ref = {'Ref. Values'; ['(0.60 ', 177, ' 0.08)']; ...
        ['(218.2 ', 177, ' 0.4)']; ['(218.2 ', 177, '0.4)']; ...
        ['(8.7 ', 177, ' 0.3)']; '-----'; ['(81.9 ', 177, ' 3.6)']; ''};

    bar_static = {''; '1.00'; ...
        sprintf('%4.1f', nmrFit_ppm.freq_inc(2)); ...
        sprintf('%4.1f', nmrFit_ppm.freq_ded(2)); ...
    ...
    bar_ref = {'Ref. Values'; '(1.0)'; ...
        ['(197.7 ', 177, ' 0.3)']; ['(197.7 ', 177, ' 0.3)']; ...
        ['(5.0 ', 177, ' 0.3)']; ['(6.1 ', 177, ' 0.3)']; '(0.0)'; ''};

    scan_strV = scan_strV + 1;
else
    fitType = 'L';
    replace(summarySlide, 'Title 1', ['Subject ', subject_id, ' s', num2str(1)]);
    rbc_static = {''; sprintf('%3.3f', nmrFit_ppm.area(1)); ...
        sprintf('%4.1f', nmrFit_ppm.freq_inc(1)); ...
        sprintf('%4.1f', nmrFit_ppm.freq_ded(1)); ...
        sprintf('%2.1f', nmrFit_ppm.fwhm(1)); '-----'; ...
    ...
    rbc_ref = {'Ref. Values'; ['(0.59 ', 177, ' 0.14)']; ...
        ['(216.0 ', 177, ' 0.7)']; ['(216.0 ', 177, ' 0.7)']; ...
        ['(10.0 ', 177, ' 0.4)']; '-----'; ['(27.3 ', 177, ' 3.6)']; ''};
...
% Add figures
p1 = mlreportgen.ppt.Picture(fullfile(path, ['dyn', fitType, imgName, '.tif']));
replace(summarySlide, 'dynPicture', p1);
p2 = mlreportgen.ppt.Picture(fullfile(path, ['dyn', fitType, '_oscs_new', imgName, '.tif']));
replace(summarySlide, 'oscillationPicture', p2);
p3 = mlreportgen.ppt.Picture(fullfile(path, ['static', fitType, imgName, '.tif']));
replace(summarySlide, 'staticPicture', p3);
p4 = mlreportgen.ppt.Picture(fullfile(path, ['dyn', fitType, '_error', imgName, '.tif']));
