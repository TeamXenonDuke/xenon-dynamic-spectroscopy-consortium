...
for idx = 1:Nsubj
    ...
    save_path = '/Users/eab78/OneDrive/Documents/Duke/CIVM Research/Siemens Data/Processed Data Peaks';
    ...
    if exist([save_path,'/spect_',subjName,'.mat'],'file')
        ...
        [amp, nmrFit, detrend, fitted] = dynamicSummary(all_twix_dyn{idx},dyn_loc,BHs,1,'_peaks','oscType','peaks','suppressFigs',true);
        ...
        dyn_folder = fileparts(all_twix_dyn{idx});
        oscSave_path = [dyn_folder,'/dyn','V','_oscs_peaks',figname,'.tif'];
        plotOscillations(dyn, BHs, detrend, fitted, 1, oscSave_path)
